# OneSys REST API Ηλεκτρονικής Τιμολόγησης 1.5.1
...
ηλεκτρονική τιμολόγηση OneSign και την υποβολή μέσω παρόχου προς την ΑΑΔΕ και στη συνέχεια προς το ΚΕΔ (ΓΓΠΣ) εφόσον αυτό απαιτείται. 
...
Ανάλογα με τις επιχειρησιακές ρυθμίσεις, το OneSign αντιμετωπίζει διαφορετικά την αδυναμία με δύο σενάρια.
...
η αποστολή στην ΑΑΔΕ. Το OneSign θα δοκιμάζει την υποβολή του μέχρι τη λήψη απάντησης από την ΑΑΔΕ οπότε και το παραστατικό
θα αποκτήσει τιμές (MARK, AUTH, UID).

#### Σενάριο 2, ο Πελάτης διαχειρίζεται την επαναυποβολή

Σε περίπτωση αποτυχίας διασύνδεσης με ΑΑΔΕ όπου το παραστατικό είναι έγκυρο, το OneSign δεν ξαναδοκιμάζει την υποβολή του
