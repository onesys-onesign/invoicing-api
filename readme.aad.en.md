# OneSys - ONESIGN API Documentation 1.5.0
...
In this scenario, on un-successful document submission from the Provider to AADE, OneSign will not re-submit the 
document to AADE. OneSign will return a response as below, and the customer is responsible for re-submitting the document.
